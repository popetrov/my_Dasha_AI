...
exports.log.add(new winston_1.default.transports.Console({
    format: winston_1.default.format.combine(winston_1.default.format.colorize(), winston_1.default.format.timestamp(), winston_1.default.format.printf(({ timestamp, label, level, message, stack }) => `${timestamp} [${label !== null && label !== void 0 ? label : "sdk"}] ${level} ${stack !== null && stack !== void 0 ? stack : message}`)),
}));
...
async function enableSentryTransport() {
    ...
    exports.log.add(new SentryTransport({
        ...
        sentry: {
            dsn,
            httpsProxy: getProxyForUrl(dsn) || undefined,
        },
    }));
